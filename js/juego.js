...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_horizontal.png', 130, 80, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 160, 80, 30, 30, 1),
    ...
    new Obstaculo('imagenes/auto_verde_derecha.png', 380, 490, 30, 15, 2),
    new Obstaculo('imagenes/auto_verde_abajo.png', 860, 360, 15, 30, 2),

    new Obstaculo('imagenes/bache.png', 820, 400, 30, 30, 3),
    new Obstaculo('imagenes/bache.png', 350, 450, 30, 30, 3),
    new Obstaculo('imagenes/bache.png', 170, 300, 30, 30, 3),
  ...
  enemigos: [
    new ZombieCaminante('imagenes/zombie1.png', 150, 150, 10, 10, 1, {desdeX: 33, desdeY: 80, hastaX: 900, hastaY: 200}),
    new ZombieCaminante('imagenes/zombie2.png', 150, 450, 10, 10, 1, {desdeX: 88, desdeY: 70, hastaX: 924, hastaY: 70}),
    new ZombieCaminante('imagenes/zombie1.png', 250, 450, 10, 10, 1, {desdeX: 66, desdeY: 60, hastaX: 1000, hastaY: 800}),
    new ZombieCaminante('imagenes/zombie3.png', 350, 450, 10, 10, 1, {desdeX: 55, desdeY: 50, hastaX: 955, hastaY: 700}),
    new ZombieCaminante('imagenes/zombie1.png', 450, 450, 10, 10 , 1, {desdeX: 99, desdeY: 40, hastaX: 900, hastaY: 900}),

    new ZombieConductor('imagenes/tren_vertical.png',644,0,30,90, 5, 2, "vertical"),
    new ZombieConductor('imagenes/tren_vertical.png',678,0,30,90, 5, 2,"vertical"),
    new ZombieConductor('imagenes/tren_horizontal.png',30,322,90,30,5,2,"horizontal"),
...
Juego.dibujar = function() {
  ...
  Dibujante.dibujarRectangulo('red', 760, 540, 127, 10)
...
Juego.moverEnemigos = function(enemigos) {
  /* COMPLETAR */
  this.enemigos.forEach(function(enemigo) {
...
Juego.chequearColisiones = function(x, y) {
  ...
  this.enemigos.forEach(function(enemigo) {
    if (this.intersecan(this.jugador, x, y)) {
